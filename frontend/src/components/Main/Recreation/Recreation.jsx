  ...
  return (
    <div className={style.container}> 
      ...
      <div className={style.table1}>
        <div className={style.wrapSel}>
        <div className={style.text}>
          <p className={style.textTime}>дата и время</p>
        </div>
      ...
      <div className={style.table2}>
        ...
        <div className={style.wrap}>
          <div className={style.text}>
            <p>поиск арендного транспорта</p>
          </div>
          <div className={style.svg}>
          <svg width="78" height="78" viewBox="0 0 105 104" fill="none" xmlns="http://www.w3.org/2000/svg">
