...
4 - localhost:8179/wtg/api/v1/locations/category/1                       - Получаем все локации по id категории (добавить категорию в локацию)
5 - localhost:8179/wtg/api/v1/locations/category/title?title=STORY       - Получаем все локации по названию категории (добавить категорию в локацию)
